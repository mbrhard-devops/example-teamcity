...
<#global titleText = "Pipeline failed to start">
...
<#global subject>[TeamCity Pipelines, FAILED TO START] Pipeline ${pipeline.name} <@common.short_build_info build/></#global>

<#global body>Pipeline ${pipeline.name} <@common.short_build_info build/> failed to start${var.buildShortStatusDescription}.
